  ...
  <article id="sobre" class="content-article">
    ...
    <div class="container">
      <section class="section">
        <h2 class="title">História 1</h2>
        <div class="bulma-clearfix-mixin">
          <figure class="image mb-4 float-left">
            <img class="float-left" src="../assets/sobreImage.png">
            <figcaption>Fonte: Primeira imagem</figcaption>
          </figure>
      ...
      <section class="section">
        <h2 class="title">História 2</h2>
        <div class="bulma-clearfix-mixin">
          <figure class="image image-half mr-4 float-left">
            <img class="float-left" src="../assets/sobreImage.png">
            <figcaption>Fonte: Segunda imagem</figcaption>
          </figure>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
          quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
